...
public class DBHP extends SQLiteOpenHelper {
	...
	String createTable = "create table bill(_id integer primary key autoincrement ,username varchar(13),number int(11),address varchar(10),company varchar(4),money int(11));";
